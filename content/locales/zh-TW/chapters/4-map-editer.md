...
:::message
查找可放置物件時，也可以搭配使用 [BF6 Object Guide](https://link1345.github.io/bf6-object-website/)。
...
## SurroundingCombatArea（HQ 的防線）

* 實體：`res://objects/gameplay/common/SurroundingCombatArea.tscn`
* 作用：在征服類玩法中，設定 HQ 周圍的禁止區域，防止敵人進入 HQ。
