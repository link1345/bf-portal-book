...
SDK 1.3.1.0 添加的文件夹中包含模板本体、字符串、图标，以及多个地图用的 `.tscn` 和 `.spatial.json`。
...
| `custom_conquest_template_V9.5.json` | Portal 区块侧模板本体 |
...
README 的更新记录把 Contaminated 和 Manhattan Bridge 作为近期追加内容。
...
4. 按分数、目标、AI、UI 等功能块阅读 `custom_conquest_template_V9.5.json`。
