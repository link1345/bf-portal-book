...
第8章では、プレイヤーに次の行動や成功の手応えを伝えるために、メッセージ、WorldIcon、SFX、FXの使い方を整理しました。けれど、体験がゲーム内で伝わるだけでは、まだ公開後に遊ばれる形にはなっていません。
本章では、作ったPortalエクスペリエンスを **人に遊んでもらえる状態で公開し、壊さず運営する** ための考え方を整理します。タイトル、説明文、サムネイル、告知、テスト、更新手順を一本の流れとして扱い、「作ったあと」に必要な作業を見える形にします。

ここでは、大規模な集客テクニックを扱うのではなく、来てくれた人が迷わず始められ、遊んだあとに直す場所が分かるように、公開前チェック、説明文、少人数運営、更新、ロールバックの関係を決めていきます。
