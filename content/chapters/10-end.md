...
第9章では公開と運営の手順を整理し、第9.5章ではAIに状況とログを渡して修正や実装を進める方法を扱いました。けれど、Portalそのもの、SDK、AI、公開まわりのルールは、この先も変わっていきます。
本章では、これまで作ってきた考え方を **変化に耐える形で残す** ために、変わりやすいものと変わりにくいものを分けて整理します。ツールが変わっても、ID管理、状態管理、見せ方、検証手順を読み替えられるようにしておきます。

ここでは、未来を言い当てることを目的にするのではなく、後から仕様や環境が変わったときに迷わないように、監視するポイント、読み替え方、残しておくべき設計の芯を決めていきます。
