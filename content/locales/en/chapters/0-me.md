...
For visual programming and map editor usage, ["BF Portal BF6 notes by TOKAI_Server_JPN"](https://w.atwiki.jp/tokaiserver/pages/1.html) provides a detailed explanation.
...
For TypeScript syntax, I recommend introductory resources such as "[Survival TypeScript](https://typescriptbook.jp/)".
For learning how to use Godot, I recommend reading the "[Godot Engine official docs](https://docs.godotengine.org/ja/4.x/)".
